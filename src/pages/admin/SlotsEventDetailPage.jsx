      ...
      <div style={s.content}>
        ...
        {activeTab === 'tokens' && (
          <div style={{ maxWidth: 440 }}>
            <p style={{ opacity: 0.6, fontSize: 13, marginBottom: 20 }}>All manual token changes are logged to the audit log.</p>
            <div style={{ display: 'flex', flexDirection: 'column', gap: 12 }}>
              ...
              <input placeholder="Reason (optional)" value={awardReason} onChange={e => setAwardReason(e.target.value)} style={s.input} />
